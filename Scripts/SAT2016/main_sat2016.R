...
benchmark_name = "SAT2016"
se.method = ""
combined = "seperate"
plot_title = "SAT16-MAIN"
...
assign_jp_optimum = function(learnertype, se.method, combined) {
  ...
  jp_values <- list(
    combined = list(
      ranger = list(
        jack = 0.02,   # Updated value
        infjack = 0.06 # Updated value
      ),
      randomForest = 0 # Updated value
    ),
    seperate = list(
      ranger = list(
        jack = 0.33,  # Updated value
        infjack = 0   # Updated value
      ),
      randomForest = 0.33 # Updated value
    )
  )
