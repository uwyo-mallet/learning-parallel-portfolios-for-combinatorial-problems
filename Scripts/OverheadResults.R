if(Sys.info()['sysname']=="Linux"){
  if(file.exists("/home/haniye/Documents/nextSteps/Scripts/PredictionResults.R")){
    source("/home/haniye/Documents/nextSteps/Scripts/PredictionResults.R") 
  }
  else{ 
    source("/gscratch/hkashgar/nextSteps/Scripts/PredictionResults.R") 
  }
} else{
  source("C:/Users/hnyk9/Thesis/nextSteps/Scripts/PredictionResults.R")
}
...
OverheadResults = R6Class(
  ...
  public = list(
    ...
    initialize = function(benchmarks_name="SAT2018", cluster = FALSE){
      ...
      if(Sys.info()['sysname']=="Linux"){
        self$actualOverheadPercore_secondsPath = paste0("/home/haniye/Documents/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_seconds/")
        self$actualOverheadPercore_secondsPlotPath = paste0("/home/haniye/Documents/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_seconds/plot/")
        self$actualOverheadPercore_percPath = paste0("/home/haniye/Documents/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_perc/")
        self$actualOverheadPercore_percPlotPath = paste0("/home/haniye/Documents/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_perc/plot/")
        
        self$actualOverheadPersolver_secondsPath = paste0("/home/haniye/Documents/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_seconds/")
        self$actualOverheadPersolver_secondsPlotPath = paste0("/home/haniye/Documents/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_seconds/plot/")
        self$actualOverheadPersolver_percPath = paste0("/home/haniye/Documents/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_perc/")
        self$actualOverheadPersolver_percPlotPath = paste0("/home/haniye/Documents/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_perc/plot/")
        if(cluster){
          self$actualOverheadPercore_secondsPath = paste0("/gscratch/hkashgar/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_seconds/")
          self$actualOverheadPercore_secondsPlotPath = paste0("/gscratch/hkashgar/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_seconds/plot/")
          self$actualOverheadPercore_percPath = paste0("/gscratch/hkashgar/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_perc/")
          self$actualOverheadPercore_percPlotPath = paste0("/gscratch/hkashgar/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_perc/plot/")
        
          self$actualOverheadPersolver_secondsPath = paste0("/gscratch/hkashgar/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_seconds/")
          self$actualOverheadPersolver_secondsPlotPath = paste0("/gscratch/hkashgar/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_seconds/plot/")
          self$actualOverheadPersolver_percPath = paste0("/gscratch/hkashgar/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_perc/")
          self$actualOverheadPersolver_percPlotPath = paste0("/gscratch/hkashgar/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_perc/plot/")
        }
      } else{
        self$actualOverheadPercore_secondsPath = paste0("C:/Users/hnyk9/Thesis/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_seconds/")
        self$actualOverheadPercore_secondsPlotPath = paste0("C:/Users/hnyk9/Thesis/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_seconds/plot/")
        self$actualOverheadPercore_percPath = paste0("C:/Users/hnyk9/Thesis/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_perc/")
        self$actualOverheadPercore_percPlotPath = paste0("C:/Users/hnyk9/Thesis/ranger_results/",self$benchmarks_name,"/actual_overhead_per_core_perc/plot/")
        
        self$actualOverheadPersolver_secondsPath = paste0("C:/Users/hnyk9/Thesis/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_seconds/")
        self$actualOverheadPersolver_secondsPlotPath = paste0("C:/Users/hnyk9/Thesis/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_seconds/plot/")
        self$actualOverheadPersolver_percPath = paste0("C:/Users/hnyk9/Thesis/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_perc/")
        self$actualOverheadPersolver_percPlotPath = paste0("C:/Users/hnyk9/Thesis/ranger_results/",self$benchmarks_name,"/actual_overhead_per_solver_perc/plot/")
      }
    ...
    actual_overhead_per_core = function(ignoreTimeouts = FALSE, 
      ...
      for(c in cores){
        ...
        write.csv(overhead,paste0(savePath,"/",c,"-cores-",type,"-overhead.csv"),row.names = FALSE)
        #plot
        if(savePlot){
    ...
    visualize_actual_overhead_per_core = function(overhead,plotPath,core,type, log ){
      ...
      ggsave(paste0(plotPath,"/",core,"-cores-",type,"-overhead.png"),plot = p,width = 10,height = 7, dpi = 150)
      return(plotPath)
    },
    ...
    actual_overhead_per_solver = function(cores_overhead_path,savePath, ignoreTimeouts = TRUE, type = "percentage-change", savePlot=TRUE, plotPath ="", log=FALSE){
      ...
      for(solver in self$sequentialData$solvers){
        ...
        write.csv(solver_overhead,paste0(savePath,"/",solver,".csv"),row.names = FALSE)
    ...
    visualize_actual_overhead_per_solver = function(solver_overhead,plotPath,solver,type, log=FALSE){
      ...
      p <- p+ stat_summary(fun=mean, geom="point", shape=20, color = "red", size = 4)
      if(log) p <- p + scale_y_continuous(trans='log10')
      ggsave(paste0(plotPath,"/",type,"-",solver,".png"), plot = p, width = 10, height = 7, dpi = 150) 
      return(plotPath)
    },
    ...
    Estimate_overhead_on_sequential = function(savePath, stat = "median",cores = c(32,30,20,10:2),solver_overhead_path, type = "percentage-change"){
      ...
      for(solver in self$sequentialData$solvers){
        file = paste0(solver_overhead_path,"/",solver,".csv")
        ...
        for(core in cores){
          if(type == "percentage-change"){
            overhead_estimates = solo_reduced[solver] * as.numeric(stat_for_cores[paste0("X",core)])
        ...
        write.csv(csv_stat,paste0(savePath,"/","Estimate_overhead_performance_",stat,"_",type,"_",solver,'.csv'),row.names = FALSE)
      }
    },
    ...
    visualize_comparison_overhead_estimation_per_solver = function(solver_overhead_path, cores = c(32,30,20,10:2),overhead_performance_mean_path, overhead_performance_median_path){
      ...
      #ggsave(paste0("./../visualization_estimate_overhead_per_solver/",solver,".png"),plot = p )
    },
    ...
    get_mcp_for_all_top_porfolios_actualRuntime_estimated_overhead = function(predictionPath,overheadPath,saveTo, stat = "median",distr = "emp", type = "percentage-change"){
        ...
        for(i in 1:length(solvers)){
          ...
          if(i>1){
            ...
            for(solver in get_top$Solver){
              file = overhead_files[which(overhead_files ==paste0(overheadPath,solver,".csv"))]
              ...
              stat_for_cores = as.numeric(stat_for_cores[paste0("X",core)])
              if(type == "percentage-change"){
      ...
      colnames(All_instances_mcp) <- c("InstanceName",c(1:39))
      write.csv(All_instances_mcp,paste0(saveTo,"/mcp_all_selections_actualruntime_estimatedoverhead.csv"),
                row.names = FALSE)
      parallelStop()
    ...
    get_mcp_for_all_top_porfolios_actualRuntime_estimated_overhead2 = function(predictionPath,overheadPath,saveTo, stat = "median",distr = "emp", type = "percentage-change"){
      self$sequentialData$ignore_instances()
      instances = sapply(list.files(predictionPath,".csv"),function(x) paste0("sat/",str_split(x,".csv")[[1]][1]),USE.NAMES = FALSE)
      solvers = self$sequentialData$solvers
      vbs_all = self$sequentialData$get_VBS()
      ...
      write.csv(All_instances_mcp,paste0(saveTo,"/mcp_all_selections_actualruntime_estimatedoverhead.csv"),
                row.names = FALSE)
      write.csv(All_instances_mcp_sec,paste0(saveTo,"/mcp_all_selections_sec_actualruntime_estimatedoverhead.csv"),
                row.names = FALSE)
      write.csv(All_instances_expectedpred,paste0(saveTo,"/mcp_all_selections_predictedruntime_estimatedoverhead.csv"),
                                            row.names = FALSE)
      write.csv(All_instances_expectedpredslowerbound,paste0(saveTo,"/mcp_all_selections_predlowerboundruntime_estimatedoverhead.csv"),
                row.names = FALSE)
      write.csv(All_instances_solver_order,paste0(saveTo,"/mcp_all_selections_predruntime_solverorder_estimatedoverhead.csv"),
                row.names = FALSE)
      write.csv(All_instances_expectedmcp,paste0(saveTo,"/expectedmcp_all_selections_predictedruntime_estimatedoverhead.csv"),
                row.names = FALSE)
      parallelStop()
      return(All_instances_mcp)
    },
    ...
    get_mcp_for_all_top_porfolios_actualRuntime_actual_overhead = function(predictionPath,overheadPath,saveTo, stat = "median",distr = "emp", type = "percentage-change"){
        ...
        for(i in 1:length(solvers)){
          ...
          if(i>1){
            ...
            for(solver in get_top$Solver){
              ...
              overhead = read.csv(file)
              overhead = overhead[order(overhead$InstanceName),]
              overhead = overhead[which(overhead$InstanceName == instance),paste0("X",core)]
      ...
      colnames(All_instances_mcp) <- c("InstanceName",c(1:39))
      write.csv(All_instances_mcp,paste0(saveTo,"mcp_all_selections_actualruntime_actualoverhead.csv"),
                row.names = FALSE)
      parallelStop()
      return(All_instances_mcp)
    },
    ...
    get_optimum_core = function(mcp_results_path,saveTo){
      mcp_frac = read.csv(paste0(mcp_results_path,"/mcp_all_selections_actualruntime_estimatedoverhead.csv"))
      ...
      for(row in 1:nrow(df)){
        ...
        if(core == 1 && df[row,]$mcp_frac ==1){
          ...
          overhead_core = read.csv(paste0(actual_overhead_per_corePath,"/",core,"-cores-percentage-change-overhead.csv"))
        }
      }
      write.csv(df,paste0(saveTo,"/actualRuntime_estimatedmeanOverhead_mcp.csv"),row.names = FALSE)
    },
    ...
    Estimate_overhead_on_prediction = function(predictionPath, cores = c(32,30,20,10:2), overheadPath,saveTo,ignoreTimeouts = TRUE,stat = "median", distr = "emp", type = "percentage-change"){
      ...
      for(core in cores){
        ...
        write.csv(overhead_csv, paste0(saveTo,"/","prediction_overhead_persolver_",core,".csv"),row.names = FALSE)
      }
    },
    ...
    predicted_overhead_per_solver = function(modelPath,saveTo, cores = c(32,30,20,10:2)){
      ...
      for(solver in predicted_overheads){
        ...
        write.csv(csv,paste0(saveTo,"/","wide_",tail(str_split(solver,"/")[[1]],1)),row.names = FALSE)
      }
    },
    ...
    Estimated_overhead_on_prediction = function(predictionPath, cores = c(32,30,20,10:2), overheadPredictionPath,saveTo,ignoreTimeouts = TRUE, type = "percentage-change"){
      ...
      for(core in cores){
        ...
        for(solver in solvers){
          #get overhead estimation percetange change, median
          file = overhead_files[which(overhead_files == paste0(overheadPredictionPath,"wide_",solver,".csv"))]
          overhead = read.csv(file)
          overhead = overhead[order(overhead$InstanceName),]
          column = overhead[paste0("X",core)]
          if(type == "percentage-change"){
        ...
        write.csv(overhead_csv, paste0(saveTo,"/","prediction+predictedoverhead_persolver_",core,".csv"),row.names = FALSE)
      }
    },
    ...
    Do_selection_considering_overhead_and_prediction = function(selectionPath, predictionOverheadPath, saveTo, top_selection = 10){
      ...
      for(instance_csv in instance_csvs){
        csv = read.csv(paste0(selectionPath,instance_csv))
        ...
        while(count_solvers>1){
          ...
          overhead_csv = read.csv(paste0(predictionOverheadPath,"/prediction_overhead_persolver_"
                                        ,count_solvers,".csv"))
          min_predictedOverhead = overhead_csv[which(overhead_csv$InstanceName == paste0("sat/",str_split(instance_csv,".csv")[[1]][1])),minpredictedrow$Solver]
          minpredictedrow$overhead_values = min_predictedOverhead
          selected_solvers = csv$Solver
          related_overhead_row = overhead_csv[which(overhead_csv$InstanceName == paste0("sat/",str_split(instance_csv,".csv")[[1]][1])),] 
        ...
        if(count_solvers !=0){
          if(count_solvers == 1){
            actual_parallel = read.csv(paste0(path,"/teton-SAT2018-39-solvers-solo-replacement.csv"))
          } else{
            actual_parallel = read.csv(paste0(path,"/teton-SAT2018-39-solvers-",
                                           count_solvers,"-parallel-replacement.csv"))
          }
          related_row = actual_parallel[which(actual_parallel$InstanceName==paste0("sat/",str_split(instance_csv,".csv")[[1]][1])),]
          for(solver in csv$Solver){
            csv[which(csv$Solver == solver),6]<- related_row[solver]
          }
        }
        write.csv(csv,paste0(saveTo,"/",instance_csv),row.names = FALSE)
      }
    },
    ...
    Do_selection_considering_overhead_and_prediction_probability = function(selectionPath, predictionOverheadPath, saveTo, top_selection = 10){
      ...
      for(instance_csv in instance_csvs){
        ...
        while(count_solvers>1){
          ...
          overhead_csv = read.csv(paste0(predictionOverheadPath,"/prediction_overhead_persolver_"
                                        ,count_solvers,".csv"))
          minpredictedrow$overhead_values = overhead_csv[which(overhead_csv$InstanceName == paste0("sat/",str_split(instance_csv,".csv")[[1]][1])),minpredictedrow$Solver]
          selected_solvers = csv$Solver
          related_overhead_row = overhead_csv[which(overhead_csv$InstanceName == paste0("sat/",str_split(instance_csv,".csv")[[1]][1])),] 
          overhead_values <- vector()
          for(solver in selected_solvers){
    ...
    Do_selection_considering_predicted_overhead_and_prediction = function(selectionPath, OverheadOnPredictionPath, saveTo, top_selection = 10){
      ...
      for(instance_csv in instance_csvs){
        ...
        while(count_solvers>1){
          ...
          overhead_csv = read.csv(paste0(predictionOverheadPath,"/prediction+predictedoverhead_persolver_"
                                        ,count_solvers,".csv"))
    ...
    Summary_results_selection = function(finalSelectionPath){
      ...
      for(instance in instance_csvs){
        ...
        if(nrow(csv)>0){
          ...
          vbs_runtime = vbs_runtime[which(vbs_runtime$InstanceName == paste0("sat/",str_split(tail(str_split(instance,"/")[[1]],1),".csv")[[1]][1])),]$VBS_Runtime
    ...
    probability_solver_time = function(Estimate_overhead_on_predictionPath, solver, time, core){
      library(EnvStats)
      overhead_csv = read.csv(paste0(Estimate_overhead_on_predictionPath,"/prediction_overhead_persolver_"
                                    ,core,".csv"))
    ...
    train_overhead_model = function(solver_overhead_path,ignoreTimeouts=TRUE,trainingcsvPath,modelPath,type = "percentage-change"){
      ...
      for(solver in solvers){
        ...
        write.csv(csv_solver,paste0(trainingcsvPath,"/", tail(str_split(solver,"/")[[1]],1)),row.names = FALSE)
      }
      ...
      for(solver in solvers){
        ...
        saveRDS(model,paste0(modelPath,"/",str_split(tail(str_split(solver,"/")[[1]],1),".csv")[[1]][1],".rds"))
        write.csv(preds , paste0(modelPath,"/",str_split(tail(str_split(solver,"/")[[1]],1),".csv")[[1]][1],".csv"),row.names = FALSE)
      }
    ...
    train_overhead_model_seprated_cores = function(solver_overhead_path,cores = c(32,30,20,10:2), ignoreTimeouts=TRUE,trainingcsvPath,modelPath,type = "percentage-change"){
      ...
      for(solver in solvers){
        ...
        csv_solver = csv_solver[order(csv_solver$InstanceName),]
        for(core in cores){
          csv_core = csv_solver[c("InstanceName",paste0("X",core))]
          ...
          write.csv(csv_core,paste0(trainingcsvPath,"/",core,"_", tail(str_split(solver,"/")[[1]],1)),row.names = FALSE)
        }
      }
      solvers = list.files(trainingcsvPath,pattern = ".csv",full.names = TRUE)
      for(solver in solvers){
