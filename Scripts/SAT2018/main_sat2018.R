cluster = NaN
learnertype = "ranger"
benchmark_name = "SAT2018"
se.method = "jack"
combined = "seperate"
plot_title = "SAT18-EXP"
...
assign_jp_optimum = function(learnertype, se.method, combined) {
  ...
  # Define a nested list (acting as a dictionary) with the latest jp_optimum values
  jp_values <- list(
    combined = list(
      ranger = list(
        jack = 0.84,   # Updated value
        infjack = 0.72 # Updated value
      ),
      randomForest = 0.95 # Updated value
    ),
    seperate = list(
      ranger = list(
        jack = 0.58,  # Updated value
        infjack = 0.55 # Updated value
      ),
      randomForest = 0.84 # Updated value
    )
  )
