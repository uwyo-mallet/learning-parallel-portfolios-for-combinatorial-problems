cluster = NaN
learnertype = "ranger"
benchmark_name = "MAXSAT2019"
se.method = "jack"
combined = "seperate"
plot_title = "MAXSAT19-UCMS"
...
assign_jp_optimum = function(learnertype, se.method, combined) {
  ...
  # randomForest
  # jp_optimum = 0.55
  # Define a nested list (acting as a dictionary) with the new jp_optimum values
  jp_values <- list(
    combined = list(
      ranger = list(
        jack = 0.17,   # Updated value
        infjack = 0.03 # Updated value
      ),
      randomForest = 0 # Updated value
    ),
    seperate = list(
      ranger = list(
        jack = 0.14,  # Updated value
        infjack = 0   # Updated value
      ),
      randomForest = 0.55 # Unchanged value
    )
  )
